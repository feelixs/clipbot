from src.misc.errors import RateLimitExceededError, TooManyTriesError
...
class TwitchAPI:
    def __init__(self, key: str, secret: str, logger, log_path: str = None, log_name: str = None, allowed_tries: int = 5):
        self.key = key
        self.logger = logger
